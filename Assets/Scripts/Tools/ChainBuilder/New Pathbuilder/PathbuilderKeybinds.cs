...
namespace NotReaper.Tools.ChainBuilder
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                {
                    ""name"": ""ChangeHandleTypeGlobal"",
                    ""type"": ""Button"",
                    ""id"": ""a9f5fdf5-0318-414a-88b1-9e74008f1991"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                ...
                {
                    ""name"": ""ChangeHandleTypeAnchor"",
                    ""type"": ""Button"",
                    ""id"": ""99812506-60a4-4c4a-86cb-ce18c1b3810f"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""07fb898c-3639-46fe-bb1f-8140cabecefa"",
                    ""path"": ""<Keyboard>/v"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""ChangeHandleTypeGlobal"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                },
                {
                    ""name"": """",
                    ""id"": ""2e99bea4-d1e0-4c76-94d4-955145aaa342"",
                    ""path"": ""<Keyboard>/g"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""ChangeHandleTypeAnchor"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
    ...
    ""controlSchemes"": []
            ...
            m_Pathbuilder_ChangeHandleTypeGlobal = m_Pathbuilder.FindAction("ChangeHandleTypeGlobal", throwIfNotFound: true);
            m_Pathbuilder_ChangeHandleTypeAnchor = m_Pathbuilder.FindAction("ChangeHandleTypeAnchor", throwIfNotFound: true);
        }
        ...
        private readonly InputAction m_Pathbuilder_ChangeHandleTypeGlobal;
        private readonly InputAction m_Pathbuilder_ChangeHandleTypeAnchor;
        public struct PathbuilderActions
        {
            ...
            public InputAction @ChangeHandleTypeGlobal => m_Wrapper.m_Pathbuilder_ChangeHandleTypeGlobal;
            public InputAction @ChangeHandleTypeAnchor => m_Wrapper.m_Pathbuilder_ChangeHandleTypeAnchor;
            ...
            public void SetCallbacks(IPathbuilderActions instance)
            {
                if (m_Wrapper.m_PathbuilderActionsCallbackInterface != null)
                {
                    ...
                    @ChangeHandleTypeGlobal.started -= m_Wrapper.m_PathbuilderActionsCallbackInterface.OnChangeHandleTypeGlobal;
                    @ChangeHandleTypeGlobal.performed -= m_Wrapper.m_PathbuilderActionsCallbackInterface.OnChangeHandleTypeGlobal;
                    @ChangeHandleTypeGlobal.canceled -= m_Wrapper.m_PathbuilderActionsCallbackInterface.OnChangeHandleTypeGlobal;
                    @ChangeHandleTypeAnchor.started -= m_Wrapper.m_PathbuilderActionsCallbackInterface.OnChangeHandleTypeAnchor;
                    @ChangeHandleTypeAnchor.performed -= m_Wrapper.m_PathbuilderActionsCallbackInterface.OnChangeHandleTypeAnchor;
                    @ChangeHandleTypeAnchor.canceled -= m_Wrapper.m_PathbuilderActionsCallbackInterface.OnChangeHandleTypeAnchor;
                }
                ...
                if (instance != null)
                {
                    ...
                    @ChangeHandleTypeGlobal.started += instance.OnChangeHandleTypeGlobal;
                    @ChangeHandleTypeGlobal.performed += instance.OnChangeHandleTypeGlobal;
                    @ChangeHandleTypeGlobal.canceled += instance.OnChangeHandleTypeGlobal;
                    @ChangeHandleTypeAnchor.started += instance.OnChangeHandleTypeAnchor;
                    @ChangeHandleTypeAnchor.performed += instance.OnChangeHandleTypeAnchor;
                    @ChangeHandleTypeAnchor.canceled += instance.OnChangeHandleTypeAnchor;
                }
            }
        }
        ...
        public interface IPathbuilderActions
        {
            ...
            void OnChangeHandleTypeGlobal(InputAction.CallbackContext context);
            void OnChangeHandleTypeAnchor(InputAction.CallbackContext context);
        }
    }
}
